...
public class ASLSourcePositionLocator implements ISourcePositionLocator {
    ...
    public ASLSourcePositionLocator() {
    }
    ...
    private final class NodeVisitor extends AbstractVisitor {
        ...
        public boolean preVisit(ASTNode element) {
            ...
            //System.out.println("anspecNodeLocator.NodeVisitor.preVisit(ASTNode):  Examining " + element.getClass().getName() +
            ...
            if (nodeStartOffset <= fStartOffset && nodeEndOffset >= fEndOffset) {
                //System.out.println("anspecNodeLocator.NodeVisitor.preVisit(ASTNode) SELECTED for offsets [" + fStartOffset + ".." + fEndOffset + "]");
                fNode[0]= element;
