...
public class ASLKWLexerprs implements lpg.runtime.ParseTable, ASLKWLexersym {
    ...
    public final static int LA_STATE_OFFSET = 139;
    ...
    public final static int ACCEPT_ACTION = 116;
    public final int getAcceptAction() { return ACCEPT_ACTION; }

    public final static int ERROR_ACTION = 117;
    ...
    public final boolean isValidForParser() { return ASLKWLexersym.isValidForParser; }
